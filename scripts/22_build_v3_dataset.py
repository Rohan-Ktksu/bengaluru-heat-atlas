...
for i, landsat_image in enumerate(
    ...
    try:
        ...
        if cloud_count == 0:
            ...
            print(
                "Skipping scene: no cloud-cover data."
            )
        ...
        feature_stack = (
            ...
            .addBands(solar_radiation)
            .addBands(cloud_cover)
            .addBands(air_temp_3day)
            .addBands(air_temp_7day)
            .addBands(lst)
        )
