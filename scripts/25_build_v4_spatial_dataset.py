...
water_projection = ee.Projection(
    "EPSG:32643"
).atScale(100)
...
for i, landsat_image in enumerate(
    ...
    try:
        ...
        if dw_count == 0:
            ...
            print(
                "Skipping scene: no Dynamic World data."
            )
        ...
        print(
            "Skipping scene and continuing."
        )

print(
    "\nV4 dataset build finished."
)
