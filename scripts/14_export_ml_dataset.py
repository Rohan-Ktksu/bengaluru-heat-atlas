...
#sample locations
samples = feature_stack.sample(region=bengaluru, scale = 30, numPixels = 5000, seed = 42, geometries = True)
print('Number of samples:')
print(samples.size().getInfo())

#export to google drive

task = ee.batch.Export.table.toDrive(collection = samples, description = "bengaluru_urban_heat_ml_dataset",fileNamePrefix = "bengaluru_urban_heat_ml_dataset", fileFormat= "CSV")
task.start()

print("Export started.")
print("Check Google Earth Engine Tasks/ Google Drive.")
